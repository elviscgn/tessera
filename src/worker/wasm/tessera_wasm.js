...
export class TesseraWasm {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        TesseraWasmFinalization.unregister(this);
        return ptr;
    }
    free() {
     ...
     */
    adapter_version() {
        const ret = wasm.tesserawasm_adapter_version(this.__wbg_ptr);
        return ret;
    }
    /**
    ...
    constructor(seed) {
        ...
        const ret = wasm.tesserawasm_new(ptr0, len0);
        if (ret[2]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('tessera_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
